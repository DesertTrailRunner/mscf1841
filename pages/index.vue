...
export default Vue.extend({
  ...
  head: {
    ...
    meta: [
      {
        hid: "description",
        name: "Monroe Street Cemetery Foundation is a 501(c)(3) nonprofit, all-volunteer organization dedicated to the preservation and enhancement of the oldest public cemetery on Cleveland's west side.",
        content: "",
      },
    ],
  },
